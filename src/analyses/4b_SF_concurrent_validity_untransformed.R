...
# Load data
df_final <- load_data(project_dir, zscored_untransformed = TRUE)
...
# Save plot
print(plot_EF)
output_file_EF <- file.path(figure_path, "SuppFig_SF_EF_untransformed.pdf")
...
output_file_subscores <- file.path(figure_path, "SuppFig_SF_EFsubscores_untransformed.pdf")
